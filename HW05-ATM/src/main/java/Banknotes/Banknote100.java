 ...
 */
public class Banknote100 implements Banknotes {
    private final static int MAX_AMOUNT_BANKNOTES = 1000;
    private String nameBanknote = BanknotesEnum.HUNDRED_100.name();
    private int nominalBanknote = BanknotesEnum.HUNDRED_100.getBanknote();
    private int amountBanknote;

    public Banknote100() {
    }

    public Banknote100(int amountBanknote) {
